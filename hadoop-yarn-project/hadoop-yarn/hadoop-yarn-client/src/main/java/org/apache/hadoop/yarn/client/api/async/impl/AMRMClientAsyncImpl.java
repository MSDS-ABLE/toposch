...
extends AMRMClientAsync<T> {
  ...
  private List<ContainerScore> scoreList = new ArrayList<>();
  ...
  public synchronized void setScoreList(List<ContainerScore> scoreList){
...
//                            ApplicationId.newInstance(1111,2222),3333),4444);
//            ContainerScore containerScore1 = ContainerScore.newInstance(containerId,0.1111);
//            ContainerScore containerScore2 = ContainerScore.newInstance(containerId,0.2222);
//            List<ContainerScore> list = new ArrayList<>();
//            list.add(containerScore1);
//            list.add(containerScore2);
            response = client.allocate(progress,scoreList);
