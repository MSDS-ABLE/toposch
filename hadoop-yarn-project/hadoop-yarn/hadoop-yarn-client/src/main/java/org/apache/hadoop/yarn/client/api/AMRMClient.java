...
public abstract class AMRMClient<T extends AMRMClient.ContainerRequest> extends
  ...
  public static class ContainerRequest {
    ...
    public ContainerRequest(Resource capability, String[] nodes,
                            String[] racks, Priority priority,MixType mixType, ServicePort port) {
      this(capability, nodes, racks, priority);
   ...
   * @throws IOException
   */
  public abstract AllocateResponse allocate(float progressIndicator,List<ContainerScore> containerScores)
                           throws YarnException, IOException;
