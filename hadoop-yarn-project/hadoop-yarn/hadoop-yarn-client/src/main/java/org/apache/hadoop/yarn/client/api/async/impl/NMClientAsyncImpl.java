...
public class NMClientAsyncImpl extends NMClientAsync {
 ...
 public void getContainerStatusAsync(ContainerId containerId, NodeId nodeId) {
  ...
  @Override
  public ServicePort GetServiceportByContainerIDAsyn(ContainerId containerId, NodeId nodeId){
    return this.client.getServicePortByContainerId(containerId, nodeId);
  }
