...
public abstract class Container implements Comparable<Container> {
  ...
  @Public
  @Stable
  public abstract MixType getMixType();

  @Private
  @Unstable
  public abstract void setMixType(MixType mixtype);


  //AM-Orchestration ZJY
  public abstract ServicePort getServicePort();

  public abstract void setServicePort(ServicePort servicePort);
  /**
