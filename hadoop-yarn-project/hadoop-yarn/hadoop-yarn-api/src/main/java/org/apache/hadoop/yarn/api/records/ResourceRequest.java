...
public abstract class ResourceRequest implements Comparable<ResourceRequest> {
  ...
  public static final class ResourceRequestBuilder {
    ...
    /**
     * Set the <code>mixType</code> of the request.
     * @param mixType
     *          <code>mixType</code> of the request
     * @return {@link ResourceRequestBuilder}
     */
    //added by Junqing Xiao 18.1.8
    @Public
    @Evolving
    public ResourceRequestBuilder mixType(
            MixType mixType) {
      resourceRequest.setMixType(mixType);
      return this;
    }

    //AM-Orchestration ZJY
    public ResourceRequestBuilder servicePort(
            ServicePort port) {
      resourceRequest.setServicePort(port);
      return this;
    }
  ...
  /**
   * Set the <code>MixType</code> of the requested container.
   *
   * @param mixType
   *          MixType of the requested container
   */
  //added by Junqing Xiao 18.1.8
  @Public
  @Evolving
  ...
  @Public
  @Evolving
  public void setServicePort(ServicePort port) {
    throw new UnsupportedOperationException();
  }
