...
public class DockerRunCommand extends DockerCommand {
  ...
  public DockerRunCommand(String containerId, String user, String image) {
    super(RUN_COMMAND);
    //change to root to start mysql
    //super.addCommandArguments("--name=" + containerId, "--user=" + user);
    super.addCommandArguments("--name=" + containerId, "--user=root");
    this.image = image;
  }

  //added by junqing xiao 18.1.16
  public DockerRunCommand addEnvKV(String key,String value) {
    super.addCommandArguments("-e",  key + "=" + value);
    return this;
  }

  //added by junqing xiao 18.1.17
  public DockerRunCommand addHost(String value) {
    super.addCommandArguments("--add-host=" + value);
    return this;
  }

  //added by junqing xiao 18.4.9
  public DockerRunCommand addExpose(Set<String> ports){
    for (String port : ports) {
      super.addCommandArguments("--expose=" + port);
    }
    return this;
  }
  ...
  //AM-Orchestration ZJY , add port mapping
  public DockerRunCommand addPortMap(String desPort, String srcPort){
    super.addCommandArguments("-m", desPort + ":" + srcPort);
    return this;
  }
  ...
  public DockerRunCommand setHostname(String hostname) {
    //add by quxm.to solve the problem about Docker's new version
