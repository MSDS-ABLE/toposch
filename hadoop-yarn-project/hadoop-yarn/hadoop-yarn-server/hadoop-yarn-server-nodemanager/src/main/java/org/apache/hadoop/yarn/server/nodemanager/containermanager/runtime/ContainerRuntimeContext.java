...
public final class ContainerRuntimeContext {
   ...
   * with using a map of stringsss to obssject.
   * @param <T>
   */
  ...
  public static final class Builder {
    ...
    public Builder(Container container, Context context){
      executionAttributes = new HashMap<>();
      this.container = container;
      this.context = context;//AM-Orchestration ZJY
    }
  ...
  private ContainerRuntimeContext(Builder builder) {
    ...
    this.context = builder.context;//AM-Orchestration ZJY
