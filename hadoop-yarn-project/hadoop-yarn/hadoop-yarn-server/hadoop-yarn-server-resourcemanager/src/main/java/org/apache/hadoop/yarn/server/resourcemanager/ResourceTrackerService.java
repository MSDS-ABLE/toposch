...
public class ResourceTrackerService extends AbstractService implements
  ...
  public NodeHeartbeatResponse nodeHeartbeat(NodeHeartbeatRequest request)
    ...
    // 8. AM-Orchestration ZJY, update using ports on NM
    for (ContainerStatus status : remoteNodeStatus.getContainersStatuses()) {
      //check whether containerstatus is sent correctly
      //rmNode.update_used_ports(status.getServicePort());
    }
