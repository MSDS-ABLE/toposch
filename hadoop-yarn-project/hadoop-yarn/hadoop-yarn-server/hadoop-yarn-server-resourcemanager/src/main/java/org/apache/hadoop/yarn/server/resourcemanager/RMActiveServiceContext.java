...
public class RMActiveServiceContext {
  ...
  @Private
  @Unstable
  public BatchAvoidManager getBatchAvoidManager(){
    return this.batchAvoidManager;
  }
  ...
  //addde by junqing xiao
  @Private
  @Unstable
  void setBatchAvoidManager(BatchAvoidManager batchAvoidManager) {
    this.batchAvoidManager = batchAvoidManager;
  }
