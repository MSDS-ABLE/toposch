...
public class RMContainerImpl implements RMContainer {
  ...
  private static class FinishedTransition extends BaseTransition {
    ...
    public void transition(RMContainerImpl container, RMContainerEvent event) {
      ...
      /** 
       ADD BY ZJY, real container statemachine transition made in RM, synchronized with NM 
      */
      LOG.info("---- FinishedTransition; container=" + container.getContainerId() + "; event=" +event);
