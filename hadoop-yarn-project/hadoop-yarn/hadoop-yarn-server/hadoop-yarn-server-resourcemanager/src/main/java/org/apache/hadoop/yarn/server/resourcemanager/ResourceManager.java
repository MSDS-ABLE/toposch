...
public class ResourceManager extends CompositeService implements Recoverable {
  ...
  //add by Junqing Xiao 18.3.25
  private BatchAvoidManager batchAvoidManager;
  ...
  public class RMActiveServices extends CompositeService {
    ...
    protected void serviceInit(Configuration configuration) throws Exception {
      ...
      //added by Junqing Xiao 18.3.25
      batchAvoidManager = createBatchAvoidManager();
      addService(batchAvoidManager);
      rmContext.setBatchAvoidManager(batchAvoidManager);
  ...
  //added by Junqing Xiao 18.3.25
  protected BatchAvoidManager createBatchAvoidManager() {
    return new BatchAvoidManager(this.rmContext);
  }
