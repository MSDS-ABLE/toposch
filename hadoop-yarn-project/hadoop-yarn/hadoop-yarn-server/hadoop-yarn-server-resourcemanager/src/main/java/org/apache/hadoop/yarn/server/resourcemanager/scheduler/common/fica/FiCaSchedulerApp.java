...
public class FiCaSchedulerApp extends SchedulerApplicationAttempt {
  ...
  public Allocation getAllocation(ResourceCalculator resourceCalculator,
    ...
    try {
      ...
      //AM-Orchestration ZJY : debug allocated containers
//      for (Container container : newlyAllocatedContainers){
//        LOG.debug("AM-Orchestration ZJY, After allocation : " + container.getServicePort().getServicePort());
//      }
