...
//    return ByteString.copyFrom((ByteBuffer)byteBuffer.duplicate().rewind());
   ...
   */
  public static MixTypeProto convertToProtoFormat(MixType e) {
    return MixTypeProto.valueOf(e.name());
  }

  public static MixType convertFromProtoFormat(MixTypeProto e) {
    return MixType.valueOf(e.name());
  }

  /**
   * AM-Orchestration ZJY serviceport
   * */
  public static ServicePortProto convertToProtoFormat(ServicePort serviceport){
    return ServicePortPBImpl.getProto(serviceport);
  }

  public static ServicePortPBImpl convertFromProtoFormat(ServicePortProto servicePortProto){
