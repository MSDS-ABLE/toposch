...
public class ResourceRequestPBImpl extends  ResourceRequest {
  ...
  private void mergeLocalToBuilder() {
    ...
    if (this.mixType != null) {
      builder.setMixType(ProtoUtils.convertToProtoFormat(this.mixType));
    }

    //AM-Orchestration ZJY
    if (this.ServicePort != null){
      builder.setServicePort(ProtoUtils.convertToProtoFormat(this.ServicePort));
    }
  }
  ...
  //added by Junqing Xiao 18.1.8.getter and setter.
  public MixType getMixType() {
    ...
    this.mixType =
            ProtoUtils.convertFromProtoFormat(p.getMixType());
    return this.mixType;
  }
  ...
  public ServicePort getServicePort() {
    ...
    this.ServicePort =
            ProtoUtils.convertFromProtoFormat(p.getServicePort());
    return this.ServicePort;
  }
